    ...
    $.fn.EasyTree = function (options) {
        ...
        this.each(function () {
                    ...
                    $(createInput).find('.confirm').click(function () {
                        ...
                        if (selected.length <= 0) {
                            ...
                            if ($(selected).hasClass('parent_li')) {
                                ...
                                $(selected).addClass('parent_li').find(' > span > span').addClass('glyphicon-minus').removeClass('glyphicon-file');
                    ...
                    if (selected.length <= 0) {
                        ...
                        $(easyTree).find('.alert .alert-content .confirm').on('click', function () {
                            ...
                            if($(selected).parent('ul').find(' > li').length <= 1) {
                                $(selected).parents('li').removeClass('parent_li').find(' > span > span').removeClass('glyphicon-minus').addClass('glyphicon-file');
            ...
            /*if (options.selectable) {
				...
				/*$(easyTree).find('li > span > a').dblclick(function(e){
					   test1();
					   e.stopPropagation();
					})*/
            //}
